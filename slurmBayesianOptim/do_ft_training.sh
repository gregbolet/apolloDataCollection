...
#SBATCH --output=training_runlog_FT.txt
...
python3 tuneRegionsMain.py --numPolicies=21 --progName=nas_ft --numTrials=3 --timeCap=0:20:00 --numRegionExecs=111 --perRegion --doStaticRuns
